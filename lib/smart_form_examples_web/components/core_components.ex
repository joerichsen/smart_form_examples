defmodule SmartFormExamplesWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SmartFormExamplesWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SmartFormExamplesWeb.Gettext, "errors", msg, opts)
    end
  end
